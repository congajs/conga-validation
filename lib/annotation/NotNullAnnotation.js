...
module.exports = class NotNullAnnotation extends Annotation {
	 ...
	 * @var {String}
	 */
	static get annotation() { return 'Assert:NotNull'; }
     ...
     * @return {String}
     */
    get validator() { return '@conga/framework-validation:validator/NotNullValidator'; }
